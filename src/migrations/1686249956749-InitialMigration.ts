...
export class InitialMigration1686249956749 implements MigrationInterface {
    name = 'InitialMigration1686249956749'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "etapas" ("id" SERIAL NOT NULL, "telefone" character varying(20), "etapa" character varying(5), "ativado" boolean NOT NULL DEFAULT true, "problema" integer, CONSTRAINT "PK_26de329bbb63ed9c4e4023b6c2f" PRIMARY KEY ("id"))`);
